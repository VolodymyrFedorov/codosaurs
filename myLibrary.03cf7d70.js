let e;var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},i={},a=t.parcelRequired7c6;null==a&&((a=function(e){if(e in n)return n[e].exports;if(e in i){var t=i[e];delete i[e];var a={id:e,exports:{}};return n[e]=a,t.call(a.exports,a,a.exports),a.exports}var l=Error("Cannot find module '"+e+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(e,t){i[e]=t},t.parcelRequired7c6=a);var l=a("bTcpz");const s={ulEl:document.querySelector(".trends__list"),btnLoad:document.querySelector(".js-load"),myLibContainer:document.querySelector(".js-mylib-container"),searchEl:document.querySelector("#genre-search")};let r=[];const o=(0,l.loadLs)(l.KEY)||[];function d(t){let n=[...t];if(n.length<9){p(n),s.btnLoad.classList.add("visually-hidden");return}let i=n.slice(0,9);n.splice(0,9),e=[...n],p(i),s.btnLoad.classList.remove("visually-hidden"),s.btnLoad.addEventListener("click",c)}function c(){if(e.length<9){p(e),s.btnLoad.classList.add("visually-hidden");return}let t=e.slice(0,9);p(t),e.splice(0,9)}function p(e){let t=function(e){let t=e.map(({id:e,genres:t,poster_path:n,release_date:i,title:a,vote_average:l})=>{var s;return`<li class="library-list trends-box" id=${e}>
              <img
  ...
  <button type="button" class="load-more js-load visually-hidden">Load more</button>`,a("epHO8"),a("bUb57"),a("eLjGg"),a("bTcpz");
//# sourceMappingURL=myLibrary.03cf7d70.js.map
