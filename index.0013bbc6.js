!function(){let e,t;var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},s={},l=i.parcelRequired7c6;null==l&&((l=function(e){if(e in a)return a[e].exports;if(e in s){var t=s[e];delete s[e];var i={id:e,exports:{}};return a[e]=i,t.call(i.exports,i,i.exports),i.exports}var l=Error("Cannot find module '"+e+"'");throw l.code="MODULE_NOT_FOUND",l}).register=function(e,t){s[e]=t},i.parcelRequired7c6=l),l("9XI3k"),l("7hKzD"),l("i8Q71"),l("gVa74");var n=l("dIxxU"),o=l("5xtVg");let r=document.querySelector(".js-upcoming-container"),c=[],_=new class{#e="https://api.themoviedb.org/3/";#t="5e0b2043a7bdefdf129debb784bbe1f7";constructor(){this.page=1}async getFilmByName(e){let t=new URLSearchParams({api_key:this.#t,query:e,page:this.page}),i=await (0,n.default).get(`${this.#e}search/movie?${t}`);if(!i.data.results.length)throw Error("OOPS...We are very sorry!We don’t have any results matching your search.");return i.data}async getFilmById(e){let t=await (0,n.default).get(`${this.#e}movie/${e}?api_key=${this.#t}`);return t.data}async getUpcomingFilm(){let i=await (0,n.default).get(`${this.#e}movie/upcoming?api_key=${this.#t}`),a=await this.getFilmById(i.data.results[Math.floor(19*Math.random())].id);!function(i){let a=i.genres.reduce((e,t)=>e+=`${t.name} `,"").split(" ").filter(e=>e);a.length=2;let s=a.join(", "),l=`<img class="upcoming__image"
...
//# sourceMappingURL=index.0013bbc6.js.map
