!function(){let e,t;var i="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},a={},l={},s=i.parcelRequired7c6;null==s&&((s=function(e){if(e in a)return a[e].exports;if(e in l){var t=l[e];delete l[e];var i={id:e,exports:{}};return a[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){l[e]=t},i.parcelRequired7c6=s),s("9XI3k"),s("7hKzD"),s("i8Q71"),s("gVa74");var n=s("dIxxU"),o=s("5xtVg");let r=document.querySelector(".js-upcoming-container"),c=[],_=new class{#e="https://api.themoviedb.org/3/";#t="5e0b2043a7bdefdf129debb784bbe1f7";constructor(){this.page=1}async getFilmByName(e){let t=new URLSearchParams({api_key:this.#t,query:e,page:this.page}),i=await (0,n.default).get(`${this.#e}search/movie?${t}`);if(!i.data.results.length)throw Error("OOPS...We are very sorry!We don’t have any results matching your search.");return i.data}async getFilmById(e){let t=await (0,n.default).get(`${this.#e}movie/${e}?api_key=${this.#t}`);return t.data}async getUpcomingFilm(){let i=await (0,n.default).get(`${this.#e}movie/upcoming?api_key=${this.#t}`),a=await this.getFilmById(i.data.results[Math.floor(19*Math.random())].id);!function(i){let a=i.genres.reduce((e,t)=>e+=`${t.name} `,"").split(" ").filter(e=>e);a.length=2;let l=a.join(", "),s=`<img class="upcoming__image"
            ...
            </div>`;r.innerHTML=s,t=i.id,e=document.querySelector(".upcoming__btn");try{let a=(0,o.loadLs)(o.KEY);a&&(c=[...a]),c.some(e=>e.id===t)&&(e.textContent="Remove from my library"),e.addEventListener("click",()=>{try{let a=(0,o.loadLs)(o.KEY);if(a&&(c=[...a]),!c.some(e=>e.id===+t)){c.push(i),(0,o.saveLs)(o.KEY,c),e.textContent="Remove from my library";return}let l=c.findIndex(e=>e.id===Number(t));c.splice(l,1),localStorage.removeItem(o.KEY),(0,o.saveLs)(o.KEY,c),e.textContent="Add to my library"}catch(e){console.error("Set state error: ",e.message)}})}catch(e){console.log(e.code)}}(a)}};_.getUpcomingFilm();var n=s("dIxxU");let p=document.querySelector(".trends__list");async function u(e){let t=await Promise.all(e.map(async({id:e,genre_ids:t,poster_path:i,release_date:a,title:l,vote_average:s})=>{var n;let o=await g(t),r=a.split("-")[0];return`<li class="trends__item" id=${e}>
        <img
